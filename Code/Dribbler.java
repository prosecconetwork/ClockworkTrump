...
public class Dribbler 
{
	...
	public void openDribbleFile(String filename)
	{
		openDribbleFile(filename, false);
	}
	
	public void openDribbleFile(String filename, boolean append)
	{
		try {
			if (!ONLY_TO_SCREEN)
			{
				dribbleStream = new FileOutputStream(filename, append);
	...
	public long getDribblePosition()
	{
		try {
	...
	public void printlnDribbleFile(String line)
	{
		try {
			if (dribbleFile != null)
			{
	...
	public void printDribbleFile(String line)
	{
		try {
			if (dribbleFile != null)
			{
